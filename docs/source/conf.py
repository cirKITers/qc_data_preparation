...
# qc_data_preparation documentation build
...
from qc_data_preparation import __version__ as release

# -- Project information -----------------------------------------------------

project = "qc_data_preparation"
author = "Kedro"
...
htmlhelp_basename = "qc_data_preparationdoc"
...
latex_documents = [
    (
        master_doc,
        "qc_data_preparation.tex",
        "qc_data_preparation Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "qc_data_preparation",
        "Project qc_data_preparation codebase.",
        "Data-Science",
    )
]
